...
export function useGoalGeneration({
  ...
  const checkAndGenerateGoal = async () => {
    ...
    try {
      ...
      if (generatedGoal) {
        ...
        const { data, error } = await supabase
          ...
          .insert({
            id: generatedGoal.id,
            user_id: generatedGoal.userId,
            target_date: generatedGoal.targetDate.toISOString(),
            target_distance: generatedGoal.targetDistance,
            target_pace: generatedGoal.targetPace,
            status: generatedGoal.status,
            auto_generated: generatedGoal.autoGenerated,
            created_at: generatedGoal.createdAt.toISOString()
          })
          .select();
